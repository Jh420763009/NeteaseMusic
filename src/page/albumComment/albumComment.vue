...
import commentbody from '@/components/albumCommentBody/albumCommentBody'
import commentfooter from '@/components/albumCommentFooter/albumCommentFooter'
...
export default {
	...
	methods:{
		loadComment(){
			//歌曲评论musiccomment.to
			apiGet.albumComment.to('/comment/album',{
				id:this.id,
				limit:this.limit
			})
			.then((res)=>{
